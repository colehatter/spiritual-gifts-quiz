  ...
  return (
    <section style={{ backgroundColor: '#F9FAFB', padding: '40px 20px' }}>
      <div style={{ maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ backgroundColor: '#F0FDF4', border: '2px solid #22C55E', borderRadius: 16, padding: '20px 24px', margin: '0 auto 20px', maxWidth: 600 }}>
          <p style={{ fontSize: '1.25rem', fontWeight: 700, color: '#111111', lineHeight: 1.6, marginBottom: 20 }}>
