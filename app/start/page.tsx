  ...
  return (
    <main className="min-h-screen bg-[#0d1220]">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="w-full mb-10 bg-[#1a2035] rounded-2xl p-6 border-2 border-[#34C6F4]" style={{ boxShadow: '0 0 30px rgba(52,198,244,0.10)' }}>
          <p className="text-white/75 text-base leading-relaxed text-left">Both options below will give you deeper, more accurate insights into how God wired you than anything you&apos;ve taken before.</p>
          <p className="text-white/75 text-base leading-relaxed mt-4 text-left">The free quiz identifies your #1 spiritual gift in about 10 minutes — and that alone can change how you see yourself.</p>
          <p className="text-white/75 text-base leading-relaxed mt-4 text-left">The full experience is something different entirely. As you answer, the AI is actually thinking — adapting in real time, selecting questions uniquely for you based on how you respond. No two people get the same assessment. When you finish, you&apos;ll receive a fully custom report: your complete gift profile ranked, a 30-day plan to activate and develop what you&apos;ve been given, Scripture specific to how you&apos;re wired, and a deep personal portrait of who you are and how you&apos;re built to serve.</p>
          <p className="text-white/90 text-base font-semibold mt-5 text-left">The free quiz tells you your gift. The full experience shows you what to do with it.</p>
        </div>
